...
func (RatePolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_profiles_f5cbead2503ead8b, []int{0}
}
...
func (*DeviceProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_profiles_f5cbead2503ead8b, []int{1}
}
...
func init() { proto.RegisterFile("profiles.proto", fileDescriptor_profiles_f5cbead2503ead8b) }

var fileDescriptor_profiles_f5cbead2503ead8b = []byte{
