...
func (*CreateServiceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{0}
}
...
func (*CreateServiceProfileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{1}
}
...
func (*GetServiceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{2}
}
...
func (*GetServiceProfileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{3}
}
...
func (*UpdateServiceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{4}
}
...
func (*DeleteServiceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{5}
}
...
func (*ListServiceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{6}
}
...
func (*ServiceProfileListItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{7}
}
...
func (*ListServiceProfileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_serviceProfile_27a68af797fbed03, []int{8}
}
...
func init() {
	proto.RegisterFile("serviceProfile.proto", fileDescriptor_serviceProfile_27a68af797fbed03)
}

var fileDescriptor_serviceProfile_27a68af797fbed03 = []byte{
