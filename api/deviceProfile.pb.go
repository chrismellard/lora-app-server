...
func (*CreateDeviceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{0}
}
...
func (*CreateDeviceProfileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{1}
}
...
func (*GetDeviceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{2}
}
...
func (*GetDeviceProfileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{3}
}
...
func (*UpdateDeviceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{4}
}
...
func (*DeleteDeviceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{5}
}
...
func (*DeviceProfileListItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{6}
}
...
func (*ListDeviceProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{7}
}
...
func (*ListDeviceProfileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceProfile_98aa0e821fa0aeaf, []int{8}
}
...
func init() { proto.RegisterFile("deviceProfile.proto", fileDescriptor_deviceProfile_98aa0e821fa0aeaf) }

var fileDescriptor_deviceProfile_98aa0e821fa0aeaf = []byte{
